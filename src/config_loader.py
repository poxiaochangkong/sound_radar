...
class AppConfig:
    audio: AudioConfig
    channel_angles: dict          # raw dict from yaml
    channel_layout_obj: ChannelLayout  # validated layout object
...
def _check_color(value: str, name: str) -> None:
...
def load_config(path: str = "config.yaml",
    ...
    Priority: profile > config.yaml > hardcoded defaults.
